...
# which continent has each of its countries not contain more than 25m

#get continents with population >= 25m, and grab the continent(s) which are not included in those 
